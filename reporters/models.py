...
class Source(models.Model):
    ...
    addresses = models.ManyToManyField('common.contact.Address', blank=True, null=True)
    phone_numbers = models.ManyToManyField('common.contact.Address', blank=True, null=True)
