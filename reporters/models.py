...
class Source(models.Model):
    ...
    addresses = models.ManyToManyField('brubeck.common.contact.Address', blank=True, null=True)
    phone_numbers = models.ManyToManyField('brubeck.common.contact.Address', blank=True, null=True)
